...
function magnews_orderby_post(){
    return array(
        'none' => __('No order', 'maanelement'),
        'ID' => __('Post ID', 'maanelement'),
        'author' => __('Author', 'maanelement'),
        'title' => __('Title', 'maanelement'),
        'date' => __('Published date', 'maanelement'),
        'modified' => __('Modified date', 'maanelement'),
        'parent' => __('By parent', 'maanelement'),
        'rand' => __('Random order', 'maanelement'),
        'comment_count' => __('Comment count', 'maanelement'),
        'menu_order' => __('Menu order', 'maanelement'),
        'post__in' => __('By include order', 'maanelement'),
    );  
}
...
function madmag_ft_images($thumbnail){
    ...
    $placeholder =  Maan_PLUGIN_URL . 'assets/lazyload.svg';
...
function maan_get_category_link($taxonomy){
...
function misha_loadmore_ajax_handler(){
    ...
    require Maan_PLUGIN_DIR.'includes/loops/'. $template .'.php';
    die(); 
}
...
function misha_tabcat_ajax_handler(){
    ...
    //require(Maan_PLUGIN_DIR.'includes/loops/tabcat.php');
    require Maan_PLUGIN_DIR.'includes/loops/'. $template .'.php';
    die(); 
}
